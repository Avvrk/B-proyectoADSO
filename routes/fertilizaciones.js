...
router.post("/", [
    ...
    check("estadoFenologico", "El estado fenologico no puede estar vacio").notEmpty(),
    check("tipo", "El tipo no puede estar vacio").notEmpty(),
    check("nombreFertilizante", "El nombre fertilizante no puede estar vacio").notEmpty(),
