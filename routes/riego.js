...
router.get('/', validarJWT, httpRiegos.getRiegos);

// Obtener riegos por ID
router.get('/:id', [
...
// Obtener cantidad de agua usada en un cultivo
router.get('/cantidad-agua/:cultivo_id', [
    check('cultivo_id', 'El ID del cultivo debe ser un mongoId válido.').isMongoId(),
    check('cultivo_id').custom(helpersRiegos.validarCultivoId),
    validarJWT,
    validarCampos
...
// Obtener riegos activos
router.get('/activos', validarJWT, httpRiegos.getRiegosActivos);

// Obtener riegos inactivos
router.get('/inactivos', validarJWT, httpRiegos.getRiegosInactivos);
