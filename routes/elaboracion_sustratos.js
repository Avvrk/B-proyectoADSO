...
router.get("/", httpElaboracionSustrato.getSustratos);
router.get("/id/:id", [
...
router.get("/operario/:empleado_idOperario", [
...
router.get("/fecha/:fechaInicio/:fechaFin", [
    ...
    check(["fechaInicio", "fechaFin"]).custom(helpersSustratos.validarFechas),
    validarCampos
], httpElaboracionSustrato.getSustratosFechas);
router.get("/responsable/:empleado_idResponsable", [
    check("empleado_idResponsable", "Ingrese un mongo id valido").isMongoId(),
...
router.post("/", [
    ...
    check("dosisUtilizada", "La dosis utilizada no puede estar vacia").notEmpty(),
    check("metodoAplicacion", "El metodo aplicacion no puede estar vacio").notEmpty(),
    check("empleado_idOperario", "El empleado operario no puede estar vacio").notEmpty(),
    check("empleado_idOperario", "Ingrese un mongo id valido").isMongoId(),
    check("empleado_idOperario").custom(helpersSustratos.validarIdEmpleado),
    check("empleado_idResponsable", "El empleado responsable no puede estar vacio").notEmpty(),
    check("empleado_idResponsable", "Ingrese un mongo id valido").isMongoId(),
    check("empleado_idResponsable").custom(helpersSustratos.validarIdEmpleado),
